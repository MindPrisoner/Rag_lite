...
def call_llm(system_prompt: str, user_prompt: str, timeout: int = 60, max_retries: int = 3) -> str:
    last_error = None
...
""".strip()
    ...
    return call_llm(SYSTEM_PROMPT, user_prompt, timeout=timeout, max_retries=max_retries)
